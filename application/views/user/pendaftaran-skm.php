<h1 class="h3 mb-4 text-center text-gray-800"><strong>pendaftaran beasiswa SKM</strong></h1>
<div class="card m-3">
	<div class="card-body">
		<form action="" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-sm-4 mt-1"><small>
						<h6><strong>DOK SURAT SKM</strong></h6>
					</small></div>
				<div class="col-sm-8 mb-2 mt-0">
					<div class="input-group mb-3">
						<label for="formFileMultiple"></label>
						<input class="form-control" type="file" id="formFileMultiple" name="dok_skm">
					</div>
					<?= form_error("dok_skm", "<small class='text-danger'>", "</small>"); ?>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-4 mt-1"><small>
