                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 font-weight-bold mb-4">Halaman Login</h1>
                                        <img src="assets/img/logo.png" width=170px height="170px">
                                    </div>
                                    <br>
                                ...
                                <form class="user" method="post" action="<?= base_url('auth'); ?>">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('auth/registration'); ?>">Belum mempunyai akun, Buat akun!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
